...
import styles from './Plaza_Installer.module.css'
...
const InstallationOption: React.FC<{props: InstallationOptionProps, versionId: string, scrollBoxRef: React.RefObject<HTMLDivElement>}> = ({props, versionId, scrollBoxRef}) => {
    ...
    useEffect(() => {
        ...
        props.callback(versionId).then(result => {
            pageStackContextValue?.setLastSubpageInternalState((state: InternalState, subpageKey: string) => {
