...
export const ListItem: React.FC<ListItemProps> = (props) => {
    ...
    return (
        <div className={props.onClick ? styles['list-item__container--clickable'] : styles['list-item__container--clickable']} style={getCssAnimation(props.animation)} onMouseDown={createRipple} onMouseUp={destroyRipple} onMouseLeave={destroyRipple}>
